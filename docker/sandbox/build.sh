...
cleanup() {
    rm -rf puppet site.yaml.template Dockerfile
}
...
ADD puppet/hieradata /etc/puppet/hieradata
...
usage() {
    ...
    echo "       -o, --operating-system                   Specify an OS from supported OS list."
    echo "                                                    RPM base: ${RPMS[*]}"
    echo "                                                    DEB base: ${DEBS[*]}"
