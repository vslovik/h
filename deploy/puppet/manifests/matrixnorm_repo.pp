...
class matrixnorm_repo {
  case $::operatingsystem {
    ...
    /(Ubuntu|Debian)/: {
      ...
      # We use code name such as trusty for Ubuntu instead of release version in matrixnorm's binary convenience repos
      ...
      Apt::Source<||> -> Exec['matrixnorm-apt-update'] -> Package<||>
    }
    default: {
